...
// static void set_layout(NotificationsOSD *self) {
//     self->win = ADW_WINDOW(adw_window_new());
//     gtk_widget_set_size_request(GTK_WIDGET(self->win), 440, 100);

//     // wire into window destroy event
//     g_signal_connect(self->win, "destroy", G_CALLBACK(on_window_destroy),
//     self);
...
//     true); gtk_layer_set_margin(GTK_WINDOW(self->win),
...
// NotificationsOSD *notification_osd_init() {
//     NotificationsOSD *self = g_malloc0(sizeof(NotificationsOSD));

//     g_debug("notification_osd.c:notification_osd_init() called");

//     set_layout(self);

//     // wire into global message-tray-mediator visible and hidden events
//     MessageTrayMediator *mtm = message_tray_get_global_mediator();
//     g_signal_connect(mtm, "message-tray-visible",
//     G_CALLBACK(on_tray_visible),
//                      self);
//     g_signal_connect(mtm, "message-tray-hidden", G_CALLBACK(on_tray_hidden),
//                      self);
//     g_signal_connect(mtm, "message-tray-will-show",
...
// void notifications_osd_free(NotificationsOSD *self) {
//     g_debug("notification_osd.c:notifications_osd_free() called");
...
//     // disconnect from MessageTrayMediator signals
//     MessageTrayMediator *mtm = message_tray_get_global_mediator();
//     g_signal_handlers_disconnect_by_func(mtm, on_tray_visible, self);
//     g_signal_handlers_disconnect_by_func(mtm, on_tray_hidden, self);
//     g_signal_handlers_disconnect_by_func(mtm, on_tray_will_show, self);
